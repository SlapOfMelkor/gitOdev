...
$stmt = $db->prepare('INSERT INTO post (baslik, icerik) VALUES (:baslik, :icerik)');


$stmt->bindValue(':baslik', $baslik);
$stmt->bindValue(':icerik', $icerik);

$result = $stmt->execute();

if (!$result) {
    echo "<p>Mesaj gönderilirken bir hata oluştu: " . $db->lastErrorMsg() . "</p>";  
}
            ...
            <div class="header-wrapper mt-5">
                <div class="row header-content">
                    <div class="header-title col-md-8">
                        <a href="index.php">Milfanin Timarhanesi</a>
                    </div>
                ...
                <div class="contact-form">
                    <form action="#" method="post">
                                ...
                                <div class="message-input">
                                    <textarea name="icerik" id="" cols="60" rows="5" placeholder="icerik"></textarea>
                                </div>                           
